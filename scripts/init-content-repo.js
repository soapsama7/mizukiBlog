...
async function main() {
	console.log("AzaMOE Content Repository Initialization\n");
	...
	const envContent = `# AzaMOE Content Repository Configuration
...
`;
	...
	console.log("Next step: run `pnpm run dev` to verify content sync.");
